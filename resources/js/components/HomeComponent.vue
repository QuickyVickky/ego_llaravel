        ...
        <section class="banner-section">
            ...
            <form @submit.prevent="sendFormSubmit" name="sendForm" id="sendForm" action="">
                <div class="container">
                    ...
                    <div class="img-wrap">
                        <img src="front/images/vec_header.svg" class="img-fluid" alt=""/>
                    </div>
                    <div class="row mb-4">
                        <div class="col-md-10 m-auto">
                            <div class="row moneytransfer-wrap">
                                <div class="col-lg-5">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group-append">
                                            <div class="btn-group dropdown-toggle" data-toggle="dropdown" @click="searchClear">
                                                <b-dropdown variant="primary" class="custom-dropdown">
                                                    <template v-slot:button-content>
                                                        <span class="input-group-addon">
                                                            <img :src="'images/country/flag-'+sendForm.sourceCurrency+ '.svg'" class="mr-1" height="20" alt="">
                                                        </span>
                                                    ...
                                                    <b-dropdown-item
                                                        ...
                                                        @click="sendForm.sourceCurrency = code;" :active="sendForm.sourceCurrency == code ? true:false">
                                                        {{ code }}({{ currency }})
                                                    </b-dropdown-item>
                                                </b-dropdown>
                                            </div>
                                         ...
                                         <div class="position-relative">
                                            <div class="btn-group dropdown-toggle" data-toggle="dropdown">
                                                <b-dropdown variant="primary" class="custom-dropdown">
                                                    <template v-slot:button-content>
                                                        <span class="input-group-addon">
                                                            <img :src="'images/country/flag-'+sendForm.targetCurrency+ '.svg'" class="mr-1" height="20" alt="">
                                                        </span>
                                                    ...
                                                    <b-dropdown-item
                                                        v-for="(currency,code) in currencies" :key="code"
                                                        @click="sendForm.targetCurrency = code;" :active="sendForm.targetCurrency == code ? true:false">
                                                        {{ code }}({{ currency }})
                                                    </b-dropdown-item>
                                                </b-dropdown>
                                            </div>
                                ...
                                <div class="col-lg-2">
                                    <button type="submit" class="btn btn-primary submit-btn" :disabled="isLoad" >Continue</button>
                                </div>
                            </div>
<!--                            <a href="#" @click="showCal=!showCal">see calculations</a>-->
                            <!-- Convert rate -->
                            <!-- <div>
                                <div class="row moneytransfer-wrapjustify-content-md-center justify-content-sm-center"
                                     v-if="rateData.source != undefined">
                                    1 {{ rateData.source }} = {{ rateData.rate }} {{ rateData.target }}
                                </div>

                                <div class="row moneytransfer-wrapjustify-content-md-center justify-content-sm-center">
                                    {{ sendForm.sourceAmount }} {{ rateData.source }} * {{ rateData.rate }} (Exchange Rate) = {{
                                    sendForm.targetAmount }} {{ rateData.target }}
                                </div>
                ...
                <div class="row  ">
                    <div class="col-lg-4 col-md-6">
                        <div class="color-box blue">
                            <img src="front/images/icons/ic_bank_deposit.svg" height="60" class="mb-3" alt="">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="color-box yellow">
                            <img src="front/images/icons/ic_bank_account.svg" height="60" class="mb-3" alt="">
                    ...
                    <div class="col-lg-4 col-md-6 m-auto">
                        <div class="color-box red">
                            <img src="front/images/icons/ic_exchange.svg" height="60" class="mb-3" alt="">
        ...
        <section class="section-padding why-choose pb-0">
            <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="d-flex align-items-baseline">
                                    <img src="front/images/bluecheck.svg" class=" mr-2" alt="">
                                    <div>
                ...
                <div class="bottom-img">
                    <img src="front/images/why-choose.svg" height="250" class="mb-3" alt="">
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 text-center-sm">
                        <img src="front/images/family_world_vector.svg" height="160" class=" mr-md-2" alt="">
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="container">
                    ...
                    <div class="row align-items-center client-logos">
                        <div class="col-md-3 col-sm-6">
                            <img src="front/images/verified_by_visa.svg" height="80" alt="">
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <img src="front/images/mastercard-securecode.svg" height="63" alt="">
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <img src="front/images/AWS_Logo.svg" height="70" alt="">
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <img src="front/images/pci-logo-high-res.svg" height="75" alt="">
                        </div>
                    </div>
                </div>
            </div>
            <div class="white-bg pb-5">
                <div class="container">
                    <div class="blue-container push-upwards">
                        ...
                        <img src="front/images/play-button.svg" height="90" class="mb-5" alt="">
                        ...
                        <div class="item">
                            <div class="review-wrap">
                                ...
                                <div class="client-image">
                                    <img src="front/images/client1.png" width="70" class="img-fluid rounded-circle"
                                         alt="">
                                </div>
                            </div>
                        ...
                        <div class="col-md-8 text-left">
                            ...
                            <div class="text-center-sm">
                                <button type="button" class="btn  btn-light mb-2 mr-lg-3"><img
                                    src="front/images/playstore.svg"
                                    height="20" class="mr-2"
                                    alt=""> Google Play
                                </button>
                                <button type="button" class="btn  mb-2 btn-light">
                                    <img src="front/images/apple.svg" class="mr-2" height="20" alt="">Apple
                                    Store
                                </button>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <img src="front/images/download-app.png" class="img-fluid" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.getExchangeRates(this.sendForm.sourceCurrency, this.sendForm.targetCurrency);
            // localStorage.setItem('sendForm', this.sendForm);
            this.targetAmountCal();
        },
        created() {
            // this.getCountry();
            this.getCurrency();
            let sendForm = JSON.parse(localStorage.getItem('sendForm'));
            if (sendForm != null) {
        ...
        methods: {
            ...
            targetAmountCal() {
                ...
                localStorage.setItem('sendForm',JSON.stringify(this.sendForm));
                this.isLoad = false;
            },
            sendFormSubmit(){
                try{
        ...
        watch: {
            ...
            "sendForm.sourceCurrency": function () {
                this.isLoad = true;
                this.getExchangeRates(this.sendForm.sourceCurrency, this.sendForm.targetCurrency);
                // localStorage.setItem('sendForm.sourceCurrency', this.sendForm.sourceCurrency);
                localStorage.setItem('sendForm',JSON.stringify(this.sendForm));

            },
            "sendForm.targetCurrency": function () {
                this.isLoad = true;
                this.getExchangeRates(this.sendForm.sourceCurrency, this.sendForm.targetCurrency);
                // localStorage.setItem('sendForm.targetCurrency', this.sendForm.targetCurrency);
                localStorage.setItem('sendForm', JSON.stringify(this.sendForm));
            },
