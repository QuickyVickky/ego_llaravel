...
<p>If you did not request a password reset, you can safely ignore this email and your current password will not change.To log back into your account <a href="{{ route('user.login') }}"> click here.</a></p>
