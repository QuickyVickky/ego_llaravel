...
@section('breadcrumbs')
    <nav class="breadcrumb-one" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><span>Fees</span></li>
        </ol>
    </nav>
@endsection
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6 col-sm-6 col-6">
                            <a class="btn btn-primary  m-2 btn-rounded float-right"
                               href="{{ route('fees.create') }}">Create Fees
                ...
                <div class="table-responsive">
                    <table id="feeDataTable" class="table table-hover" style="width:100%">
                        ...
                        <tbody>
                            @foreach($fees as $fee)
                                <tr>
                                    <td>{{ $transfer[$fee->type] }}</td>
                                    <td>{{ $fee->percentage }} %</td>
                                    <td>{{ date('d-m-Y',strtotime($fee->created_at)) }}</td>
                                    <td class="project-actions text-center">
                                        <div class="btn-group btn-group-sm">
                                            <a class="btn btn-info btn-sm edit-btn" href="{{ route('fees.edit',$fee->id) }}" title="Edit">
