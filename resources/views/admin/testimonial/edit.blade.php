                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company_name"
                                           ...
                                           id="company_name" placeholder="Enter company name" value="{{ $testimonial->company_name }}">
                                    @error('company_name')
                                    <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="designation"
                                           ...
                                           id="designation" placeholder="Enter designation" value="{{ $testimonial->designation }}">
                                    @error('designation')
                                    <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('comment') is-invalid @enderror" rows="4"
                                              name="comment" id="comment" placeholder="Enter comment">{{ $testimonial->comment }}</textarea>
                                    @error('comment')
                                    <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group clearfix pt-15">
                                    ...
                                    <div class="icheck-primary d-inline">
                                        <input type="checkbox" name="status" id="checkboxPrimary1" @if($testimonial->status)checked @endif>
