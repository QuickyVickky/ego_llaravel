...
<!-- Mirrored from designreset.com/cork/ltr/demo4/pages_coming_soon.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 04 Aug 2020 10:29:07 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, shrink-to-fit=no">
    <title>Coming Soon | EgoGram </title>
    <link rel="icon" type="image/x-icon" href="assets/img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="{{ asset('admin/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin/assets/css/plugins.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('admin/assets/css/pages/coming-soon/style.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="coming-soon-wrap">
            <div class="coming-soon-container">
                <div class="coming-soon-content">
                    ...
                    <p class="terms-conditions">© 2020 All Rights Reserved. <a href="#">EgoGram</a>. <a href="javascript:void(0);">Cookie Preferences</a>, <a href="javascript:void(0);">Privacy</a>, and <a href="javascript:void(0);">Terms</a>.</p>
    ...
    <div class="coming-soon-image">
        <div class="l-image">
            <div class="img-content">
                <img src="{{ asset('admin/assets/img/mindset.svg') }}" alt="coming_soon">
            </div>
        </div>
    </div>
</div>
...
<script src="{{ asset('admin/assets/js/pages/coming-soon/coming-soon.js') }}"></script>
