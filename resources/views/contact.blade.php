...
@section('content')
    <div id="content-block">
        ...
        <div class="block-entry fixed-background" style="background-image: url('{{ asset('public/front/img/background-26.jpg')}}')">
            <div class="container">
                <div class="row">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src=" {{ asset('public/front/img/icon-25.png')}}" alt="">
                ...
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src=" {{ asset('public/front/img/icon-23.png')}}" alt="">
                ...
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src=" {{ asset('public/front/img/icon-28.png')}}" alt="">
                ...
                <div class="col-sm-3">
                    <div class="icon-description-shortcode style-1">
                        <img class="icon" src=" {{ asset('public/front/img/icon-26.png')}}" alt="">
        ...
        <div class="container">
            <div class="map-wrapper">
                <div id="map-canvas" class="full-width" data-lat="34.0151244" data-lng="-118.4729871"
                     data-zoom="14"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <form class="contact-form">
                        <div class="row m5">
                            <div class="col-sm-6">
                                <input class="simple-input col-xs-b20" type="text" value="" placeholder="Name"
                                       name="name"/>
                            </div>
                            <div class="col-sm-6">
                                <input class="simple-input col-xs-b20" type="text" value="" placeholder="Email"
                                       name="email"/>
                            </div>
                            <div class="col-sm-6">
                                <input class="simple-input col-xs-b20" type="text" value="" placeholder="Phone"
                                       name="phone"/>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-12">
                                <textarea class="simple-input col-xs-b20" placeholder="Your message"
                                ...
                                <div class="text-center">
                                    <div class="button size-2 style-3">
                                        <span class="button-wrapper">
                                            <span class="icon"><img src=" {{ asset('public/front/img/icon-4.png')}}" alt=""></span>
...
@section('js')
    ...
    <!-- CONTACT -->
    <script src="{{ asset('public/front/js/contact.form.js')}}"></script>
@endsection
